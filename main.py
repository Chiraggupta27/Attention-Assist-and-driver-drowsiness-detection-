...
label.pack(side=TOP)
filename = PhotoImage(file="chirag.png")
...
def main():
    ...
    while True:  # infinite loop for webcam video capture
        ...
        but1=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=main,text='Open Camera',font=('helvetica 15 bold'))
